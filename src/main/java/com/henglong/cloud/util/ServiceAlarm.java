...
public class ServiceAlarm extends AppenderBase<ILoggingEvent> {
    ...
    public static String WEBHOOK_TOKEN = "https://oapi.dingtalk.com/robot/send?access_token=b621c865e76c6a6caff9ec8919019d04c52629361332db375f146c0e4b0c95c6";
    ...
    protected void append(ILoggingEvent iLoggingEvent) {
        if (iLoggingEvent != null && iLoggingEvent.getMessage() != null) {
            ...
            try {
                ...
                out.append("{ \"msgtype\": \"text\", \"text\": {\"content\": \"云算力销售系统(测试)出现异常！其摘要信息为【"+iLoggingEvent.getMessage()+"】，请前往日志文件查看\"}}");
                out.flush();
                out.close();
